...
*
* Part 1 of the infamous elevator lab where elevator patrons are to enter
* elevator one at a time
* and be delivered the floor they request.  The concepts involved here are
* p_thread synchronization and scheduling
* algorithms.
*/
